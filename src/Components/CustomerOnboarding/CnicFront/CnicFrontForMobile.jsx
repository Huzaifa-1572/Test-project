...
const CnicFrontForMobile = ({ control, getValues, errors, watch, setValue }) => {
                    ...
                    {isCameraAccessAllowed ? (
                        !!CNIC_FRONT ? (
                            <>
                                ...
                                <Alert sx={{ background: '#dceeff', margin: '20px 0px' }} variant="outlined" severity="info">
