...
import OpenNewAccount from "src/Assets/Icons/NewApplication.png";
import resumeAccount from "src/Assets/Icons/ResumeApplication.png";
        ...
        <Container maxWidth="xl" className={styles.contentContainer} sx={{ padding: { xs: '10px', lg: 0 }, display: 'flex', alignItems: 'center', borderRadius: { lg: '15px' }, minHeight: '100%' }}>
          <Grid container spacing={2} sx={{ height: '100%', display: "flex", justifyContent: "center", alignItems: "center" }}>
            ...
            <Grid item xl={6} sx={{ justifyContent: "center", alignItems: "center", display: { xs: 'none', xl: 'flex' } }}>
              <img src={heroImage} alt="WALLET" className={styles.heroImage} loading="lazy" />
            </Grid>
